        ...
        <section className="mb-6">
          <div className="flex space-x-4">
            ...
            <label
              ...
              className={`w-24 h-24 flex items-center justify-center rounded-lg shadow cursor-pointer ${uploadedImages.length >= 4 ? "bg-gray-200 cursor-not-allowed" : "bg-gray-200"
                }`}
