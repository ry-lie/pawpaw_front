              ...
              {isEditing ? (
                <div className="flex gap-1">
                  ...
                  <button
                    ...
                    className={`py-1 px-2 rounded-lg border ${pet.breed === '여자' ? 'bg-red-100' : 'bg-white'
                      }`}
                  >
                    <Image
                      src={WomanIcon}
                  ...
                  <button
                    ...
                    className={`py-1 px-2 rounded-lg border ${pet.breed === '남자' ? 'bg-blue-100' : 'bg-white'
                      }`}
                  >
                    <Image
                      src={ManIcon}
              ...
              {isEditing ? (
                <div className="flex gap-1">
                  <button
                    ...
                    className={`py-1 px-2 text-base font-semibold rounded-lg border ${pet.size === '소형' ? 'bg-stroke_gray' : 'bg-white'
                      }`}
                  >
                    소
                  </button>
                  <button
                    ...
                    className={`py-1 px-2 text-base font-semibold rounded-lg border ${pet.size === '중형' ? 'bg-stroke_gray' : 'bg-white'
                      }`}
                  >
                    중
                  </button>
                  <button
                    ...
                    className={`py-1 px-2 text-base font-semibold rounded-lg border ${pet.size === '대형' ? 'bg-stroke_gray' : 'bg-white'
                      }`}
                  >
                    대
                  </button>
